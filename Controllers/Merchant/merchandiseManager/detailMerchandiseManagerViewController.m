...
- (void)viewWillAppear:(BOOL)animated{
    ...
    //商品上架Button
    UIButton *addMerchandiseButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 64, SHPWIDTH, 44)];
    [addMerchandiseButton setTitle:@"新品上架" forState:UIControlStateNormal];
    [addMerchandiseButton setTitleColor:SHPBLUE forState:UIControlStateNormal];
    ...
    //tablewiew
    self.merchandiseTableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 64+44+2, SHPWIDTH, SHPHEIGHT-64-44-2-49) style:UITableViewStyleGrouped];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UITextField *merchandiseIDField =  [[UITextField alloc] initWithFrame:CGRectMake(115, 0, SHPWIDTH-115, 44)];
    merchandiseIDField.text = instanceOfMerchandise.merchandiseID;
    //商品名
    UILabel *merchandiseName = [[UILabel alloc] initWithFrame:CGRectMake(15, 44, SHPWIDTH-30, 44)];
    merchandiseName.text = @"商品名:";
    UITextField *merchandiseNameField =  [[UITextField alloc] initWithFrame:CGRectMake(115, 44, SHPWIDTH-115, 44)];
    merchandiseNameField.text = instanceOfMerchandise.merchandiseName;
    //商品描述
    UITextView *merchandiseDescription = [[UITextView alloc] initWithFrame:CGRectMake(15, 44*2, SHPWIDTH-30, 44)];
    ...
    merchandiseDescription.layer.borderWidth = 0.2;
     merchandiseDescription.layer.borderColor = [SHPBLUE CGColor];
    //价格
    UILabel *price = [[UILabel alloc] initWithFrame:CGRectMake(15, 44*3, SHPWIDTH/2-15, 44)];
    price.text = [@"¥ " stringByAppendingString:instanceOfMerchandise.price] ;
    //库存
    UILabel *quantity = [[UILabel alloc] initWithFrame:CGRectMake(SHPWIDTH/2, 44*3, SHPWIDTH/2-15, 44)];
